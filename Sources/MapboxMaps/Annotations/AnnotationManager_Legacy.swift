 ...
 */
public class AnnotationManager_Legacy: Observer {
    ...
    internal var styleDelegate: AnnotationStyleDelegate_Legacy

    /**
     The map object this class will use when querying for annotations.
     */
    internal weak var mapView: AnnotationSupportableMap_Legacy?
     ...
     */
    internal var annotationOptions: AnnotationOptions_Legacy
     ...
     */
    internal init(for mapView: AnnotationSupportableMap_Legacy,
                  with styleDelegate: AnnotationStyleDelegate_Legacy,
    ...
    internal func updateAnnotationOptions(with newOptions: AnnotationOptions_Legacy) {
    ...
    internal func updateSymbolStyleLayer(for pointAnnotation: PointAnnotation_Legacy) throws {
        ...
        if styleDelegate.getStyleImage(with: PointAnnotation_Legacy.defaultIconImageIdentifier) == nil {

            let expectedDefaultImage = styleDelegate.setStyleImage(image: pointAnnotation.defaultAnnotationImage(),
                                                                   with: PointAnnotation_Legacy.defaultIconImageIdentifier,
                                                                   sdf: false,
                                                                   stretchX: [],
                                                                   stretchY: [],
                                                                   scale: 3.0,
